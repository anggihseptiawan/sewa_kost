<div class="content">
        ...
        <!-- <div id="login">
            ...
            <button type="submit" name="submit" class="button button-s button-full button-circle shadow-medium bg-highlight">Login</button> 
            </form>           
        </div> 
 -->
        <div id="register">
            ...
            <button type="submit" name="regis" class="button button-s button-full button-circle shadow-medium bg-highlight">Register</button> 
            </form>
        </div>
        ...
        <div class="profile">
            ...
            <img src="<?= base_url(); ?>vendor/images/img1.jpg" alt="user-image">
            <p>Nama : Agus salim</p>
            <p>Email : agus_salim@gmail.com</p>
            <a href="<?= base_url('post_iklan'); ?>" class="button button-s button-full button-round-large shadow-medium bg-highlight" style="margin-top: 15px;">Posting iklan</a>
